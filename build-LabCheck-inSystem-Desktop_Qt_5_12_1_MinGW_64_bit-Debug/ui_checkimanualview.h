/********************************************************************************
** Form generated from reading UI file 'checkimanualview.ui'
**
...
#ifndef UI_CHECKIMANUALVIEW_H
#define UI_CHECKIMANUALVIEW_H
...
public:
    ...
    void setupUi(QDialog *CheckIManualView)
    {
        if (CheckIManualView->objectName().isEmpty())
            CheckIManualView->setObjectName(QString::fromUtf8("CheckIManualView"));
        CheckIManualView->resize(400, 209);
        QFont font;
        font.setPointSize(10);
        CheckIManualView->setFont(font);
        horizontalLayoutWidget = new QWidget(CheckIManualView);
        ...
        formLayoutWidget = new QWidget(CheckIManualView);
        ...
        horizontalLayoutWidget_2 = new QWidget(CheckIManualView);
        ...
        QWidget::setTabOrder(CancelButton, pushButton);

        retranslateUi(CheckIManualView);

        QMetaObject::connectSlotsByName(CheckIManualView);
    } // setupUi

    void retranslateUi(QDialog *CheckIManualView)
    {
        CheckIManualView->setWindowTitle(QApplication::translate("CheckIManualView", "Dialog", nullptr));
        CheckInButton->setText(QApplication::translate("CheckIManualView", "Check-In", nullptr));
        CancelButton->setText(QApplication::translate("CheckIManualView", "Cancel", nullptr));
        pushButton->setText(QApplication::translate("CheckIManualView", "Swipe Card", nullptr));
        nameLabel->setText(QApplication::translate("CheckIManualView", "First Name:", nullptr));
        ySUIDLabel->setText(QApplication::translate("CheckIManualView", "YSU ID:", nullptr));
        birthdayLabel->setText(QApplication::translate("CheckIManualView", "Birthday:", nullptr));
        lastNameLabel->setText(QApplication::translate("CheckIManualView", "Last Name:", nullptr));
        label->setText(QApplication::translate("CheckIManualView", "Check-In Form", nullptr));
    } // retranslateUi

};

namespace Ui {
    class CheckIManualView: public Ui_CheckIManualView {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CHECKIMANUALVIEW_H
